...
inherit cmake-multilib elisp-common multilib toolchain-funcs
...
if [[ "${PV}" == *9999 ]]; then
	...
	KEYWORDS="~alpha ~amd64 ~arm ~arm64 ~loong ~mips ~ppc ~ppc64 ~riscv ~s390 ~sparc ~x86 ~arm64-macos ~x64-macos"
