...
SRC_URI="
	https://github.com/Blosc/c-blosc2/archive/v${PV}.tar.gz
		-> ${P}.gh.tar.gz
	https://github.com/LLNL/zfp/archive/${ZFP_PV}.tar.gz
		-> ${ZFP_P}.gh.tar.gz
"
...
src_configure() {
	...
	local mycmakeargs=(
		...
		# TODO: unbundle? make plugins optional?
		-DBLOSC_ZFP_SOURCE_DIR="${WORKDIR}/${ZFP_P}"
		...
		# why do we need to pass it explicitly?
