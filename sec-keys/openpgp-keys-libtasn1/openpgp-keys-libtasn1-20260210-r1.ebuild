...
SEC_KEYS_VALIDPGPKEYS=(
	B1D2BD1375BECB784CF4F8C4D73CF638C53C06BE:josefsson1:manual,openpgp,ubuntu
	# opengpg cannot be used due to missing user ID's
	0424D4EE81A0E3D119C6F835EDA21E94B565716F:josefsson2:manual,ubuntu
	# opengpg cannot be used due to missing user ID's
	9AA9BDB11BB1B99A21285A330664A76954265E8C:nmav:manual,ubuntu
	# opengpg cannot be used due to missing user ID's
	1F42418905D8206AA754CCDC29EE58B996865171:josefsson3:manual,ubuntu
)
